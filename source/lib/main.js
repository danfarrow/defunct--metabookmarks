...
/**
 * HACK Use `localhost/bookmarks/*` as a handle
 * to request a page showing a list of bookmarks
 *
 * @todo How to then trigger the doo-dah?
 */
function setUpPageMod(){
	pattern = "chrome://metabookmarks/content/test.html";
...
/**
 * Make some test bookmarks for testing testness
 *
 * @return Null
 */
